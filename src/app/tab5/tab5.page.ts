...
export class Tab5Page implements OnInit {
  ...
  cards: any = {
    'inquisitor': {
      name: 'Inquisitor', type: 'dps', hasePhases: false, mainDpsBaseDamage: 120, mainDpsBaseSpeed: 0.6, tier: true, level: true, talent: 'none', absorbs: 1,
    ...
    'boreas': { name: 'Boreas', type: 'dps', hasePhases: true, mainDpsBaseDamage: 120, mainDpsBaseSpeed: 0.09, mainDpsBaseCrit: 0, mainDpsFirstPhase: 4.6, mainDpsSecondPhase: 1.7, mainDpsActivationInterval: 4.7 },
    'sentry': { name: 'Sentry', type: 'dps', hasePhases: true, mainDpsBaseDamage: 456, mainDpsBaseSpeed: 0.09, mainDpsBaseCrit: 0, mainDpsDamageIncrease: 244, mainDpsActivationInterval: 0.95 },
    'crystalmancer': { name: 'Crystal Mancer', type: 'dps', hasePhases: true, mainDpsBaseDamage: 197, mainDpsBaseSpeed: 0.07, mainDpsBaseCrit: 0, mainDpsDamageIncrease: 800, mainDpsActivationInterval: 0.95 },
    'demonhunter': { name: 'Demon Hunter', type: 'dps', hasePhases: false, mainDpsBaseDamage: 1136, mainDpsBaseSpeed: 0.45, mainDpsBaseCrit: 0, demonHunterEmpowered: true, tier: 7, mainDpsDamageIncrease: 75 },
    'generic': { name: 'Generic', type: 'dps', hasePhases: false, mainDpsBaseDamage: 64, mainDpsBaseSpeed: 0.6, mainDpsBaseCrit: 0 },
  ...
  damageReport() {
    ...
    for (let row = 0; row < 3; row++) {
      for (let column = 0; column < 5; column++) {
        if (this.gridRows[row][column].type == 'dps') {
          let tileInfo: any = { main: this.gridRows[row][column], row, column };
          let adjacentUnits: any = [];
          if (row > 0) {
          ...
          tileInfo.adjacentUnits = adjacentUnits.filter((unit: any) => unit.id != '');
